        ...
        <div className="menu">
          <div className="menu-main">
            <div className="menu-top">
              ...
              <div className="menu-top-content">
                ...
                <div className="menu-item">
                  <div className="menu-item-link">
                    <div className="bg-hover"></div>
                    <a href={GMAIL_COMPOSE_URL} target="_blank" rel="noopener noreferrer" className="split-target">contact</a>
                  </div>
            ...
            <div className="menu-bottom">
              ...
              <a href={GMAIL_COMPOSE_URL} target="_blank" rel="noopener noreferrer" className="hover:scale-110 active:scale-95 transition-transform duration-200" aria-label="Gmail">

...
function AnimatedMenu(props) {
  ...
  const perspectiveAnimation = { initial: { opacity: 0, rotateX: 100, translateY: 80 }, enter: (i) => ({ opacity: 1, rotateX: 0, translateY: 0, translateX: 0, transition: { delay: i * linkDelayOffset, type: "spring", stiffness: linkStiffness, damping: linkDamping, mass: 0.8 } }) };
  const footerAnimation = { initial: { opacity: 0, y: 20 }, enter: (i) => ({ opacity: 1, y: 0, transition: { delay: 0.5 + i * 0.1, type: "spring", stiffness: linkStiffness, damping: linkDamping, mass: 0.8 } }) };
  const menuAnimation = { open: { width: isMobile ? menuWidthMobile : menuWidthDesktop, height: isMobile ? menuHeightMobile : menuHeightDesktop, top: "0px", right: "0px", transition: { type: "spring", stiffness: springStiffness, damping: springDamping, mass: springMass } }, closed: { width: buttonWidth, height: buttonHeight, top: "8px", right: "8px", transition: { type: "spring", stiffness: springStiffness, damping: springDamping, mass: springMass } } };
  if (isStatic) {
    return /* @__PURE__ */ _jsx("div", { style: { position: "relative", display: "inline-block", width: buttonWidth, height: buttonHeight }, children: /* @__PURE__ */ _jsx("button", { style: { width: buttonWidth, height: buttonHeight, borderRadius: "25px", border: "none", backgroundColor: btnClosedBg, color: btnClosedColor, fontSize: `${btnFontSizeDesktop}px`, ...menuFontStyle, fontWeight: menuFontStyle.fontWeight ?? 500, cursor: "pointer" }, children: "MENU" }) });
  }
...
function Menubutton({ click, setClick, isMobile, btnClosedBg, btnClosedColor, btnOpenBg, btnOpenColor, btnFontSizeDesktop, btnFontSizeMobile, menuId, menuOpen }) {
  ...
  return /* @__PURE__ */ _jsx("button", { onClick: () => setClick(!click), onMouseEnter: () => setHovered(true), onMouseLeave: () => setHovered(false), "aria-expanded": menuOpen, "aria-haspopup": "menu", "aria-controls": menuId, "aria-label": click ? "Close menu" : "Open menu", style: { position: "absolute", top: "8px", right: "8px", cursor: "pointer", fontFamily: "inherit", zIndex: 2, width: isMobile ? "90px" : "110px", height: isMobile ? "40px" : "46px", borderRadius: "25px", overflow: "hidden", border: "none", padding: 0, backgroundColor: "transparent" }, children: /* @__PURE__ */ _jsxs(motion.div, { style: { position: "relative", width: "100%", height: "100%" }, animate: { y: click ? "-100%" : "0%" }, transition: { type: "spring", stiffness: 200, damping: 22 }, children: [/* @__PURE__ */ _jsxs("div", { style: { position: "relative", height: "100%", width: "100%", overflow: "hidden" }, children: [/* @__PURE__ */ _jsx(motion.div, { style: { height: "100%", width: "100%" }, animate: { y: hovered ? "-100%" : "0%" }, initial: false, transition: { type: "spring", stiffness: 200, damping: 22 }, children: /* @__PURE__ */ _jsx(ButtonLabel, { bg: btnClosedBg, clr: btnClosedColor, fontSize, children: "MENU" }) }), /* @__PURE__ */ _jsx(motion.div, { style: { position: "absolute", inset: 0 }, animate: { y: hovered ? "0%" : "100%" }, transition: { type: "spring", stiffness: 200, damping: 22 }, initial: false, children: /* @__PURE__ */ _jsx(ButtonLabel, { bg: btnClosedBg, clr: btnClosedColor, fontSize, children: "MENU" }) })] }), /* @__PURE__ */ _jsxs("div", { style: { position: "relative", height: "100%", width: "100%", overflow: "hidden" }, children: [/* @__PURE__ */ _jsx(motion.div, { style: { height: "100%", width: "100%" }, animate: { y: hovered ? "-100%" : "0%" }, transition: { type: "spring", stiffness: 200, damping: 22 }, children: /* @__PURE__ */ _jsx(ButtonLabel, { bg: btnOpenBg, clr: btnOpenColor, fontSize, children: "CLOSE" }) }), /* @__PURE__ */ _jsx(motion.div, { style: { position: "absolute", inset: 0 }, animate: { y: hovered ? "0%" : "100%" }, transition: { type: "spring", stiffness: 200, damping: 22 }, initial: false, children: /* @__PURE__ */ _jsx(ButtonLabel, { bg: btnOpenBg, clr: btnOpenColor, fontSize, children: "CLOSE" }) })] })] }) });
}

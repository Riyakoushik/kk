...
function Ticker(props) {
  let { slots = [], gap = 10, padding = 10, paddingPerSide, paddingTop, paddingRight, paddingBottom, paddingLeft, speed = 100, hoverFactor = 1, direction = "left", alignment = "center", sizingOptions = { widthType: true, heightType: true }, fadeOptions = { fadeContent: true, overflow: false, fadeWidth: 25, fadeAlpha: 0, fadeInset: 0 }, style } = props;
...
var __FramerMetadata__ = { "exports": { "default": { "type": "reactComponent", "name": "Ticker", "slots": [], "annotations": { "framerContractVersion": "1", "framerIntrinsicHeight": "200", "framerSupportedLayoutHeight": "fixed", "framerSupportedLayoutWidth": "fixed", "framerDisableUnlink": "*", "framerIntrinsicWidth": "400" } }, "__FramerMetadata__": { "type": "variable" } } };
export {
  __FramerMetadata__,
  Ticker as default
};

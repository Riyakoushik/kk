...
export function CallToAction() {
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-6 py-20 bg-black text-white">
      {/* Background Radial Gradient */}
      <div
        className="absolute inset-0 z-0"
        style={{
          background:
            "radial-gradient(ellipse at 50% 100%, rgba(255, 159, 28, 0.15) 0%, rgba(0, 0, 0, 0) 75%)",
          opacity: 0.8,
        }}
      >
        <div
          style={{
            ...
            backgroundImage:
              "repeating-radial-gradient(circle at 50% 100%, transparent 0px, transparent 20px, rgba(255, 159, 28, 0.05) 20px, rgba(255, 159, 28, 0.05) 21px)",
            height: "100%",
            left: "0",
            maskImage:
              "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.45) 100%)",
      ...
      <div className="relative overflow-hidden z-10 max-w-4xl w-full text-center">
        <div className="space-y-6">
          <div className="space-y-4 pb-8">
            <h2 className="text-3xl font-extrabold uppercase md:text-6xl tracking-tight text-white font-mono">
              Start Your Project Today
            </h2>
            <p className="text-white/65 max-w-2xl mx-auto text-sm md:text-lg font-light leading-relaxed">
              Bring your ideas to life with professional architectural direction.
              Whether it’s automation, systems design, or AI agents, I am ready to help.
            </p>
          </div>

          <div className="flex justify-center py-4">
            <WhatsAppJoin className="h-48 w-auto text-[#ff9f1c]/20 max-w-full" />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-6">
            <a 
              ...
              className="inline-flex items-center justify-center h-12 px-8 font-bold text-sm tracking-wider uppercase bg-[#ff9f1c] hover:bg-[#ffb03a] text-black rounded-lg transition-all duration-300 transform hover:-translate-y-0.5"
            >
              Book a Call
            </a>
            <a 
              ...
              className="inline-flex items-center justify-center h-12 px-8 font-bold text-sm tracking-wider uppercase bg-white/5 hover:bg-white/10 text-white border border-white/15 hover:border-white/30 rounded-lg transition-all duration-300 transform hover:-translate-y-0.5 gap-2"
            >
...
const WhatsAppJoin = (props) => (
  ...
  >
    <g>
      ...
      <path d="M364,278.01c0,4.99,0,10.02,0,15.01,4.65.04,9.35-.06,14.01,0,.01,4.65-.04,9.35,0,14-9.65.02-19.35-.03-29,0,.08-9.65-.06-19.35,0-29.01,4.99-.03,10.02.05,15.01,0ZM189,453.01c.05-4.65-.03-9.35,0-14h15c.03,4.65-.05,9.35,0,14-4.99-.04-10.01.01-15,0Z" />
      ...
      <path d="M204,59.01c-.05,4.65.03,9.35,0,14.01-4.99-.04-10.02.03-15.01,0,.04-4.65-.03-9.35,0-14.01,4.99.04,10.02-.05,15.01,0ZM320,249.01c-.05,4.65.03,9.35,0,14h-15c-.07,4.98.09,10.02,0,15-2.93-.03-6.18.45-8.99-.49,5.99-8.21,9.06-18.06,10.88-27.93.78-1.15,10.81-.55,13.12-.58Z" />
